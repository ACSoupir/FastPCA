...
```{r time_mem, echo = FALSE, fig.pos="H", out.width="75%", fig.align='center', fig.cap="Time and memory usage of singular value decomposition methods."}
...
```{r singular_values, echo = FALSE, fig.pos="H", out.width="90%", fig.align='center', fig.cap="Singular values derived from different methods plotted against each other."}
