...
#' }
deprecated.setup_py_env <- function(method = c("conda", "virtualenv"),
                         envname = "FastPCA",
                         cuda = FALSE,
                         ...) {
  ...
  if (reticulate::py_available(initialize = FALSE)) {
    ...
    if (reticulate::py_module_available("torch") && reticulate::py_module_available("numpy") && reticulate::py_module_available("tinygrad")) {
